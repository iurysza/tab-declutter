...
const ports: AppPorts = {
  ...
  settings: { loadProvider: vi.fn(async () => undefined), loadCriteria: vi.fn(async () => []), loadSelectedCriterion: vi.fn(async () => 'project'), saveSelectedCriterion: vi.fn(async () => {}) },
...
it('rejects malformed messages and never serializes provider settings', async () => {
